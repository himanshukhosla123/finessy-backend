...
public interface IUniversitySQL {
    
	String ADD_UNIVERSITY = "INSERT INTO university_details(`university_id`, `university_name`, `campus_size`, `founded`, `type`,"
	...
	String UPDATE_UNIVERSITY = "UPDATE university_details SET university_id=? university_name=? campus_size=? founded=? type=?"
