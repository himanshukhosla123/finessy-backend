...
public interface CountryDetailsSQL {
    
	String ADD_COUNTRY = "INSERT INTO country_details(`country_name`, `no_of_students`,"
	...
	String UPDATE_COUNTRY = "UPDATE country_details SET country_name=? no_of_students=?"
			+ " international_students_percent=? status=? happiness_index=? languages_spoken=? political_stability=?"
